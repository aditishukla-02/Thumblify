  ...
  return (
    <div className="relative space-y-3">
      ...
      <button
        ...
        bg-white/8 border-white/10 text-zinc-200 hover:bg-white/12 transition"
      >
      ...
      {isOpen && (
        <div
          className="absolute z-50 mt-1 w-full rounded-md border
          border-white/12 bg-black/20 backdrop-blur-xl shadow-lg"
        >
